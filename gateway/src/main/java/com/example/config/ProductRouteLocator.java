...
public class ProductRouteLocator {
    ...
    @Value("${route.product-api.v1.base-url}")
    ...
    @Order(1)
    @Bean
    public RouteLocator getProductRoute(RouteLocatorBuilder routeLocatorBuilder, AuthFilter authFilter) {
        return routeLocatorBuilder.routes()
                .route("product-api",
                        r -> r.path(gatewayPath + "products/**")
